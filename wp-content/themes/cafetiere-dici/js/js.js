/**
 * Scripts should only be executed when most of the page has been loaded
 */
...
var wheelOpt = passiveSupport ? {
    passive: false
} : false;
var wheelEvent = 'onwheel' in document.createElement('div') ? 'wheel' : 'mousewheel';

// Function to disable scrollbar
function disableScroll() {
    window.addEventListener('DOMMouseScroll', preventDefault, false); // For older FF
    window.addEventListener(wheelEvent, preventDefault, wheelOpt); // For modern desktop
